...
void* p1(){
    ...
    printf("philosopher 1 has got a bowl");
    printf("philosopher 1 has released a bowl");
...
void* p2(){
    ...
    printf("philosopher 2 has got a bowl");
    printf("philosopher 2 has released a bowl");
...
void* p3(){
    ...
    printf("philosopher 3 has got a bowl");
    printf("philosopher 3 has released a bowl");
...
void* p4(){
    ...
    printf("philosopher 4 has got a bowl");
    printf("philosopher 4 has released a bowl");
...
void* p5(){
    ...
    printf("philosopher 5 has got a bowl");
    printf("philosopher 5 has released a bowl");
